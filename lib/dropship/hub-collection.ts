...
export const HUB_COLLECTION_NOTES =
  "Pedido de compra de Alcéntimo. Apártalo y márcalo listo para recolección. Alcéntimo o su transporte lo retira en tu almacén. No despaches ni cobres al cliente final.";
