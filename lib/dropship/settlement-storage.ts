...
export const DROPSHIP_SETTLEMENT_PROOFS_BUCKET = "dropship-settlement-proofs";
...
export async function uploadDropshipSettlementProof(
  userId: string,
  file: File,
  ...
  const { error: uploadError } = await admin.storage
    .from(DROPSHIP_SETTLEMENT_PROOFS_BUCKET)
