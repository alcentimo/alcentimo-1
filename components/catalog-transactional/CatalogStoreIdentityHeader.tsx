...
export function CatalogStoreIdentityHeader({
  ...
  const showWhatsApp = Boolean(shellNav?.whatsAppAvailable);
    ...
    >
      ...
      <div className="txn-catalog-header-inner">
        <div className="txn-catalog-identity-card">
          ...
          {showAssistant || showWhatsApp ? (
            <div className="txn-catalog-header-actions">
              {showAssistant ? (
                <button
                  type="button"
              ...
              {showWhatsApp ? (
                <button
                  type="button"
                  className="txn-catalog-whatsapp-btn"
