...
import {
  ...
  type FacebookPostCallToAction,
} from "@/lib/facebook/call-to-action";
...
export function FacebookPostModal({
  ...
  const [callToAction, setCallToAction] =
    useState<FacebookPostCallToAction>("message");
        ...
        <div className="inbox-composer-publish-body">
          {product.thumb_url ? (
            <div className="inbox-composer-publish-preview">
              ...
              <p className="inbox-composer-publish-preview-note">
                Vista previa de la imagen que se publicará en tu página.
              </p>
            </div>
          ) : (
          ...
          <label className="inbox-composer-publish-label">
            ...
            <select
              value={callToAction}
              onChange={(event) =>
                setCallToAction(event.target.value as FacebookPostCallToAction)
              }
              disabled={isPublishing || Boolean(permalinkUrl)}
              className="inbox-composer-publish-select"
            >
          ...
          {permalinkUrl && (
            <div className="inbox-composer-publish-success">
              ...
              <div className="min-w-0">
                <p className="inbox-composer-publish-success-title">
                  ¡Publicado con éxito!
                </p>
                <a
                  href={permalinkUrl}
