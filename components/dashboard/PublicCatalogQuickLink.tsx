...
export function PublicCatalogQuickLink({
  ...
  if (variant === "header") {
    return (
      <div className={cn("dashboard-header-catalog-links flex items-center gap-1 sm:gap-1.5", className)}>
        <button
          type="button"
          ...
          className={cn(
            "inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border text-sm font-semibold shadow-sm transition-colors sm:h-9 sm:w-auto sm:gap-1.5 sm:px-3",
            copied
        ...
        <a
          ...
          className="inline-flex h-9 w-9 shrink-0 items-center justify-center gap-1.5 rounded-lg border border-teal-600/20 bg-teal-600 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-teal-700 sm:h-9 sm:w-auto sm:px-3 dark:border-teal-500/30 dark:bg-teal-600 dark:hover:bg-teal-500"
        >
