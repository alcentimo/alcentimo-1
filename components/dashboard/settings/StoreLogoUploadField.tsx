...
export function StoreLogoUploadField({
  ...
  return (
    <div className="space-y-2">
      ...
      {warning && !error ? (
        <p
          className="rounded-lg border border-amber-200 bg-amber-50 px-2.5 py-1.5 text-xs text-amber-800 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-300"
          role="status"
        >
          {warning}
        </p>
